...
class MeasureFormHandler
{
    ...
    public function removeChoiceItems(Measure $entity)
    {
    ...
    public function removeDirectObservationItems(Measure $entity)
    {
    ...
    public function removeIntegerItems(Measure $entity)
    {
    ...
    public function removeMeterItems(Measure $entity)
    {
    ...
    public function removeRangeItems(Measure $entity)
    {
    ...
    public function removeTextItems(Measure $entity)
    {
